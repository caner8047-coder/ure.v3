...
<body>
    <div class="auth-wrapper flex-column">
        <h1 style="font-family: 'Inter', sans-serif; font-weight: 800; font-size: 2.8rem; letter-spacing: -0.05em; color: #0f172a; margin-bottom: 2rem;">
            zolfa <span style="font-size: 0.9rem; font-weight: 700; letter-spacing: 0; color: #64748b; vertical-align: super;">v0.3</span>
        </h1>
