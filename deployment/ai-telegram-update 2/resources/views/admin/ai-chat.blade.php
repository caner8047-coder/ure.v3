...
<div class="container-fluid">
    <div class="chat-container">
        ...
        <div class="suggestions">
            <span class="suggestion-btn" onclick="sendSuggestion('Kac personel var?')">Kac personel?</span>
            <span class="suggestion-btn" onclick="sendSuggestion('Su an kac gorev devam ediyor?')">Aktif gorevler</span>
            <span class="suggestion-btn" onclick="sendSuggestion('Kritik stoklar hangileri?')">Kritik stoklar</span>
            <span class="suggestion-btn" onclick="sendSuggestion('Son 5 tamamlanan gorev nedir?')">Son tamamlananlar</span>
        </div>
